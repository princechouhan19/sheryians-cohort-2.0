# Sheryians Cohort 2.0 – Learning Journey
...
- **[1. JS Essentials](./DSA-JS/1]JS-Essentials)**: Core building blocks of JavaScript programming.
- **[2. Operators](./DSA-JS/2]Operators)**: Understanding arithmetic, logical, and comparison operators.
- **[3. Math Functions](./DSA-JS/3]Math-Functions)**: Utilizing JavaScript's Math object for problem-solving.
- **[4. Conditional Statements](./DSA-JS/4]Conditional-Statements)**: Implementing control flow and logic (if-else, switch).
- **[5. Loops](./DSA-JS/5]Loops)**: Handling iteration natively (for, while, do-while).
- **[6. Arrays](./DSA-JS/6]Arrays)**: Data storage, traversal, and advanced array manipulation.
- **[7. Searching Algorithms](./DSA-JS/7]Searching-Algorithms)**: Implementing techniques like Linear and Binary Search.
- **[8. Sorting Algorithms](./DSA-JS/8]Sorting-Algorithms)**: Efficiently organizing data sets using sorting mechanisms.
- **[9. Strings](./DSA-JS/9]String)**: Extensive string manipulation and built-in JS string methods.
...
1. Explore topic folders organized by module
2. Review my handwritten notes and solutions
3. Run project code in relevant folders
4. Compare learning outcomes with official syllabus
